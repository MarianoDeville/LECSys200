...
public class CtrlBajaInsumo implements ActionListener {

	private NuevoSimple ventana;
	private DtosInsumos dtosInsumos;
	
	public CtrlBajaInsumo(NuevoSimple vista) {
	...
	public void iniciar() {
		...
		ventana.lblFormato.setText("Descontar:");
	...
	void guardarCambios( ) {
		...
		if(!dtosInsumos.setStockDescontar(ventana.txtFormato.getText())) {
